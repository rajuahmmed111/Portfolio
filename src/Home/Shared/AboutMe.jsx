    ...
    return (
        <div id='about' className="bg-opacity-20  md:p-24 p-8">
            <div className="lg:w-full  w-full  text-slate-300">
                <h2 className="text-4xl font-bold text-emerald-400 md:mb-10 mb-8 lg:ml-14">About Me</h2>
                <div className='mx-auto md:flex  items-center justify-around '>
                    ...
                    <div>
                        <img className='md:h-[200px] lg:h-[350px] h-[200px] md:pl-10' src={image2} alt="" />
                    </div>
                </div>
            </div>
        </div>
