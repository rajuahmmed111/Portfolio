        ...
        <div id="contact">
            <div className=" py-10 md:flex justify-between px-5 md:px-0">
                <div className="container mx-auto px-5 md:px-20 text-gray-200">
                    <h2 className="text-4xl text-emerald-400 font-bold pb-4">Contact Information</h2>
                    ...
                    <div className="text-center w-full pt-20 flex text-5xl gap-5 mx-auto"><a href="mailto:nusratjahan3657r@gmail.com" className="text-yellow-600"><IoMdMail></IoMdMail></a>
                        <a href="https://www.linkedin.com/in/nusrat-jahan-r7/" target="_blank" rel="noopener noreferrer" className="text-blue-700"><FaLinkedin></FaLinkedin></a>
